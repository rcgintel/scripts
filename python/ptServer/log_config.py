...
def get_client_logger():
    ...
    if "client_logger" not in logging.Logger.manager.loggerDict:
        ...
        CLIENT_LOG_FILENAME = f'ptServerCLI_{os.environ.get("USER")}.log'


        client_logger = logging.getLogger('client_logger')
        client_logger.setLevel(CLIENT_LOG_LEVEL)
        client_file_handler = logging.FileHandler(CLIENT_LOG_FILENAME,mode = 'a')
...
def get_server_logger():
    ...
    if 'server_logger' not in logging.Logger.manager.loggerDict:
        ...
        SERVER_LOG_FILENAME = f'ptServerMachineSpawn_{os.environ.get("USER")}.log'


        server_logger = logging.getLogger('server_logger')
        server_logger.setLevel(SERVER_LOG_LEVEL)
        server_file_handler = logging.FileHandler(SERVER_LOG_FILENAME, mode = "a")
