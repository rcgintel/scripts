...
logFileName = f'ptServerMachineSpawn_{os.environ.get("USER")}.log'

import shutil 
if os.path.isfile(logFileName):
    new_filename = f'ptServerMachineSpawn_{os.environ.get("USER")}_{datetime.datetime.now().strftime("%Y%m%d%H%M%S")}.log'
    shutil.move(logFileName, new_filename)
